...
var page = require("app_storefront_base/cartridge/controllers/CheckoutServices");
server.extend(page);
var csrfProtection = require('*/cartridge/scripts/middleware/csrf');

server.replace(
    'SubmitPayment', server.middleware.post,
...
server.replace('PlaceOrder',server.middleware.post, server.middleware.https, function (req, res, next) {
    var BasketMgr = require('dw/order/BasketMgr');
