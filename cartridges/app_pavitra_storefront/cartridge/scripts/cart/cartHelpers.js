    ...
    if(product.ID === 'donation_p'){
        Transaction.wrap(function () {
            if (donationUserDetails) {
                productLineItem.custom.donationFirstNameP = donationUserDetails.firstName;
                ...
                productLineItem.custom.donationAmountP = donationUserDetails.amount;
...
function addProductToCart(currentBasket, productId, quantity, childProducts, options, donationUserDetails) {
    var availableToSell;
